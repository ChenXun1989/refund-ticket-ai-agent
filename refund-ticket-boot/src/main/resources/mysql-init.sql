...
('BT20231201001', '张三', 58.00, '万达影城（王府井店）', '长津湖之水门桥', '2023-12-01 14:30:00'),
('BT20231201002', '李四', 68.00, '大地影院（朝阳门店）', '流浪地球2', '2023-12-01 19:00:00'),
('BT20231202003', '王五', 48.00, '博纳国际影城（CBD店）', '满江红', '2023-12-02 10:00:00');

-- 退票记录测试数据
INSERT INTO refund_ticket (buy_ticket_code, code, user_name, status) VALUES
('BT20231201001', 'RT20231201001', '张三', 'PENDING'),
('BT20231201002', 'RT20231201002', '李四', 'PROCESSING');
